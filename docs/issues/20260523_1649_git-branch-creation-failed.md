...
`git checkout -b feature/add-branch-operation-skills` を実行したところ、以下のエラーで作業ブランチを作成できなかった。

```text
fatal: cannot lock ref 'refs/heads/feature/add-branch-operation-skills': unable to create directory for .git/refs/heads/feature/add-branch-operation-skills
```
